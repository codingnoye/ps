...
void append(int i, bool front) {
    int val = cumsum[i];
    int oldlen = (deq[101000+val].size()>=2) ? deq[101000+val].back() - deq[101000+val].front() : 0;
    if (front)
        deq[101000+val].push_front(i);
    else
        deq[101000+val].push_back(i);
    int newlen = (deq[101000+val].size()>=2) ? deq[101000+val].back() - deq[101000+val].front() : 0;
...
void remove(int i, bool front) {
    ...
    int oldlen = (deq[101000+val].size()>=2) ? deq[101000+val].back() - deq[101000+val].front() : 0;
    if (front)
        deq[101000+val].pop_front();
    else
        deq[101000+val].pop_back();
    int newlen = (deq[101000+val].size()>=2) ? deq[101000+val].back() - deq[101000+val].front() : 0;
